...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.createUser = function () {
        ...
        if (this.user.password !== this.confirmPassword) {
            ...
            var user = this.userService.findUserByUsername(this.user.username);
            if (user) {
                this.errorFlag = true;
                this.errorMsg = 'User already exists';
            }
            else {
                var newUser = this.userService.createUser(this.user);
                if (newUser) {
                    this.router.navigate(['/user', user._id]);
                }
                else {
...
var WebsiteEditComponent = (function () {
    ...
    WebsiteEditComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.params.subscribe(function (params) {
            ...
            _this.siteName = _this.website['name'];
            _this.siteDesc = _this.website['description'];
        });
    };
    ...
    WidgetImageComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.params.subscribe(function (params) {
            ...
            if (_this.widgetId) {
                ...
                _this.imgName = _this.widget['name'];
                _this.imgText = _this.widget['text'];
                _this.imgUrl = _this.widget['url'];
                _this.imgWidth = _this.widget['width'];
    ...
    WidgetYoutubeComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.params.subscribe(function (params) {
            ...
            if (_this.widgetId) {
                _this.widget = _this.widgetService.findWidgetById(_this.widgetId);
                _this.widgetEdit = true;
                _this.vidName = _this.widget['name'];
                _this.vidText = _this.widget['text'];
                _this.urlYoutube = _this.widget['url'];
                _this.vidWidth = _this.widget['width'];
            }
        });
    };
